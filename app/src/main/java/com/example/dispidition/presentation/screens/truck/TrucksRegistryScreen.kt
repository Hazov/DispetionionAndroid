    ...
    fun Show(modifier: Modifier = Modifier) {
        ...
        Column {
            LazyColumn(
                ...
                items(
                    listOf(
                        Truck("Volvo", "FH12", "Активна"),
                        Truck("DAF", "XF105", "Ремонт"),
                        Truck("Scania", "R400", "Парк"),
                        Truck("Volvo", "FH12", "Активна"),
                        Truck("DAF", "XF105", "Ремонт"),
                        Truck("Scania", "R400", "Парк"),
                        Truck("Volvo", "FH12", "Активна"),
...
data class Truck(val mark: String, val model: String, val status: String)